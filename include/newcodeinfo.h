...
extern char _LD_SYMBOL_CUSTOM_CODE_START;
#define NEWCODE_OFFSET ((u32) & _LD_SYMBOL_CUSTOM_CODE_START)
 ...
 */
extern char _LD_SYMBOL_CUSTOM_CODE_SIZE;
#define NEWCODE_SIZE ((u32) & _LD_SYMBOL_CUSTOM_CODE_SIZE)
